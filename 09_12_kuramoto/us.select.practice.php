...
if($statusp==false){
    ...
    $view .='<tr>';
    $view .='<td>';
    $view .='<a href="us.detail.practice.php?id='.$res["id"].'" class="phph">';
    $view.=$res['book_name'].'</td><td>'.$res['book_url'].'</td><td>'.$res['comments'].'</td>';
    // $view.='<td>'.$res['id'].'</td><td>'.$res['book_name'].'</td><td>'.$res['book_url'].'</td><td>'.$res['comments'].'</td>';
    // $view.='<tr>''<td>'$res['id'].'</td>''<td>'",".$res['book_name'].'</td>''<td>'",".$res['book_url'].'</td>''<td>'",".$res['comments']'</td>''</tr>';
    $view .='</a>';
    $view .='</td>';
//     $view .=' ';
//     $view .='<td>';
...
<header>
  <nav class="navbar navbar-default">
    ...
    <a class="navbar-brand" href="logout.practice.php">Out</a>
      </div>
    </div>
  </nav>
</header>;
